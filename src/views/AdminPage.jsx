...
const AdminPage = ( props ) => {
    ...
    const project = props.location && props.location.state && props.location.state.project;
    ...
    return (
        ...
        // <>
        //     <h1 className="text-page my-8 ml-8">Admin Page</h1>
        ...
        //         </Form.Item>
        //         <Form.Item>
        //             <Button htmlType="submit" onClick={handleCreate} className="btn ml-8">Save</Button>
        //         </Form.Item>
        //
        //         {showPopup ? (
        //             <div
        ...
        //                     <p className="text-2xl p-5">Project is updated!</p>
        //
